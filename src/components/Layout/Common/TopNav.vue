  ...
  <div class="mx-auto px-2 py-4 flex justify-between">
    ...
    <div class="flex justify-between w-[40%]">
        ...
        <div class="relative group">
          ...
          >
            <ul class="flex justify-center items-center">
              ...
              <li class="font-oxygen text-[12px] cursor-pointer py-2 px-4 text-gray-500 border-b-2"
                >German</li
              >
            </ul>
          </div>
      ...
      <div class="flex justify-between">
        <div>
          <span class="font-oxygen font-bold text-[18px] block whitespace-nowrap">Gautam Yadav</span>
