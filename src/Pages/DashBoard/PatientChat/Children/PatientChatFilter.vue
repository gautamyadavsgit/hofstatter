<template>
  <div
    class="text-center grid grid-cols-4 justify-between items-center gap-6 chat-shadow-double h-[70px]"
  >
    <a
...
export default {
  data() {
    return {
      // data property for setting the active class on the a element default is all
      activeElement: "all",
    };
  },
  methods: {
